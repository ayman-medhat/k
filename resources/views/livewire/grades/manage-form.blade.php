...
<style>
    ...
    <div class="form-card">
        <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 0.5rem;">
            <a href="{{ route('grades') }}" wire:navigate class="btn-secondary" style="padding: 0.4rem 0.8rem; font-size: 0.85rem;">← Back</a>
        </div>
        ...
        <form wire:submit.prevent="save">
            ...
            <div class="actions">
                <a href="{{ route('grades') }}" wire:navigate class="btn-secondary">Cancel</a>
