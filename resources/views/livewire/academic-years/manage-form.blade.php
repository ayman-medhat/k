...
<style>
    ...
    <div class="form-card">
        <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 0.75rem;">
            <a href="{{ route('academic-years') }}" wire:navigate class="btn-secondary" style="padding: 0.4rem 0.8rem; font-size: 0.85rem;">{{ __('general.back') }}</a>
        </div>
        <h1>{{ $academicYear ? __('academic-years.edit_year') : __('academic-years.new_year') }}</h1>

        <form wire:submit.prevent="save">
            <div class="form-group">
                <label>{{ __('academic-years.year') }}</label>
                <input type="text" wire:model.blur="name" placeholder="e.g. 2025-2026">
            ...
            <div class="actions">
                <a href="{{ route('academic-years') }}" wire:navigate class="btn-secondary">{{ __('general.cancel') }}</a>
